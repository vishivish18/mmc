...
class Contact extends React.Component {
  ...
  render() {
    ...
    <div>
      ...
      <div className="row text-center">
      <div className="col-12">
      <div className="mapouter"><div className="gmap_canvas"><iframe className="location-iframe" id="gmap_canvas" src="https://maps.google.com/maps?q=maestro%20music%20club&t=&z=12&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div></div>
      </div>
      <div className="col-12" style={{marginTop:120}}>
